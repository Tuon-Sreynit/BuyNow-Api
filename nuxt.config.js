    ...
    auth: {
        strategies: {
          local: {
            ...
            endpoints: {
              login: { url: 'https://buynow-api.onrender.com/auth/login', method: 'post' },//login to get token
              user: { url: 'https://buynow-api.onrender.com/auth/me', method: 'get' }//auto request to backend as a verification token is valid
              // logout: { url: 'https://buynow-api.onrender.com/api/user/logout', method: 'post' },
            },
          },
        },
      },
