...
export default {
  ...
  created() {
    ...
    methods: {
      ...
      // let products=[]
            axios
                .get(`https://buynow-api.onrender.com/api/product/${this.id}`)
                .then((res) => {
      ...
      //       axios
      //           .get(`https://buynow-api.onrender.com/api/movie/subcategory/${this.id}`)
      //           .then((res) => {
      ...
      this.isLoading = true
        ...
        await this.$axios.put(`https://buynow-api.onrender.com/api/product/${this.id}`, data)
